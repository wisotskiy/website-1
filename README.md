...
---
Дя того, чтобы убрать отображение категории на главной странице и из меню, необходимо её удалить из файла "order.mdx". Чтобы потом открыть, нужно её добавить в кавычках, и, если она не последняя, поставить запятую: "wedding-photos",   .