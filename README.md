...
---
Для того, чтобы убрать отображение категории на главной странице и из меню, необходимо её удалить из файла "order.mdx". На будущее, чтобы потом легче было найти, все категории находятся в файле "order_stored_services.mdx".